...
import { CustomersSharedModule } from 'app/shared';
import { CustomersCoreModule } from 'app/core';
import { CustomersAppRoutingModule } from './app-routing.module';
import { CustomersHomeModule } from './home/home.module';
import { CustomersAccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        CustomersSharedModule.forRoot(),
        CustomersCoreModule,
        CustomersHomeModule,
        CustomersAccountModule,
